...
/**
 * Wheel-orbit simulator constants.
 ...
 * Orbital period:      ~7,069.6 s  (~1.96 h)
 */
 ...
 * Returns the orbital position of the wheel-craft at time t (seconds).
 *
 ...
 *
 * Query params:
 *   t  {number}  Elapsed time in seconds (default: 0)
 */
...
app.listen(PORT, () => {
  console.log(`Orbit-sim server running on http://localhost:${PORT}`);
